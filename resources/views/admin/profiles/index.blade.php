    ...
    <div class="profile-foreground position-relative mx-n4 mt-n4">
                    ...
                    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                        <div class="row g-4">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="{{ asset("theme/admin/assets/images/users/avatar-1.jpg")}}" alt="user-img"
                                            ...
                                            <div class="col-xxl-3">
                                                            ...
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">+(84) 987 6543</td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">26/08/2004</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center mb-4">
                                                            <div class="flex-grow-1">
                                                                <h5 class="card-title mb-0">Học sinh tham gia khoá học</h5>
                                                            </div>
                                                            <div class="flex-shrink-0">
                                                                <div class="dropdown">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="d-flex align-items-center py-3">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="{{ asset("theme/admin/assets/images/users/avatar-5.jpg")}}" alt=""
                                                                        class="img-fluid rounded-circle" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center mb-4">
                                                            <div class="flex-grow-1">
                                                                <h5 class="card-title mb-0">Bài viết thịnh hành</h5>
                                                            </div>
                                                            <div class="flex-shrink-0">
                                                                <div class="dropdown">
                                            ...
                                            <div class="col-xxl-9">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <p>Hi I'm {{ Auth::user()->name }}, It will be as simple as Occidental; in
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Khoá học đã năng lên</h5>
                                                        <!-- Swiper -->
