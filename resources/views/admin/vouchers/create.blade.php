...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('.adminvouchers.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ old('name') }}" name="name" class="form-control" placeholder="Tên voucher" id="name">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" value="{{ old('code') }}" class="form-control" placeholder="Mã voucher" id="code">
                                    <small class="help-block form-text text-danger">
                                        @if ($errors->has('code'))
                                            {{ $errors->first('code') }}
                                        @endif
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" value="{{ old('start_time') }}" id="start_time" name="start_time" placeholder="Start time" class="form-control">
                                    <small class="help-block form-text text-danger">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" id="end_time" value="{{ old('end_time') }}" name="end_time" placeholder="End time" class="form-control">
                                    <small class="help-block form-text text-danger">
