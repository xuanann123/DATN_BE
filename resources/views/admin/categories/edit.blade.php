                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="{{ route('.admincategories.update', ['category' => $category->id]) }}"
                                ...
                                <div class="row form-group mt-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" value="{{ old('name') ?? $category->name }}" id="name"
                                            name="name" placeholder="Name" class="form-control"><small
                                ...
                                <div class="row form-group mt-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" value="{{ old('slug') ?? $category->slug }}" id="slug"
                                ...
                                <div class="row form-group mt-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" value="{{ old('description') ?? $category->description }}"
                                ...
                                <div class="row form-group mt-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <label class="switch">
                                            <input {{ $category->is_active == 1 ? 'checked' : '' }} name="is_active"
