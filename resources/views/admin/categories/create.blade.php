                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ old('name') }}" name="name" class="form-control" placeholder="Tên danh mục" id="name">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" value="{{ old('slug') }}" class="form-control" placeholder="Đường dẫn thân thiện" readonly id="slug">
                                    <small class="help-block form-text text-danger">
                                        @if ($errors->has('slug'))
                                            {{ $errors->first('slug') }}
                                        @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="parent_id" id="parent_id" class="form-control">
                                        ...
                                        @foreach($options as $id => $name)
                                            <option {{ old('parent_id') == $id ? 'selected' : '' }} value="{{ $id }}">{!! $name !!}</option>
                                        @endforeach
                                    </select>
                                    <small class="help-block form-text text-danger">
