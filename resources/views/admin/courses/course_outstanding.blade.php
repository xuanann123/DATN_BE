                    ...
                    <div class="card-header d-flex justify-content-between gap-3">
                        <div class="col-sm-auto d-flex ms-2">
                            <ul class="d-flex gap-4 mt-1 list-unstyled">
                                <li><a href="#">Tất
                                        cả({{ $countCourse }})</a></li>
                                <li><a href="#">Nổi bật({{ $countCourseOutstanding }})</a></li>
{{--                                <li><a href="{{ request()->fullUrlWithQuery(['status' => 'active']) }}">Chưa nổi bật(10)</a></li>--}}
                            </ul>
                        </div>
                        <div class="col-sm-auto d-flex ms-2">
                            <form action="{{ route('admin.approval.courses.course-outstanding') }}" method="GET" class="d-flex gap-2">
                                @csrf
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.approval.courses.add-and-remove-outstanding') }}">
                            @csrf
                            @method("PUT")
                            <div class="row mb-3">
                                <div class="col-md-4 d-flex">
                                    <select name="action" id="" class="form-select">
                                        ...
                                        <option value="add-course-outstanding" class="form-control">Thêm nổi bật khóa học</option>
                                        <option value="remove-course-outstanding" class="form-control">Xóa nổi bật khóa học</option>
                                    </select>
                                    <button class="btn btn-outline-primary ms-2" type="submit">
                                        Chọn
                                    </button>
