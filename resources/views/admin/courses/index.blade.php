...
@section('content')
    ...
    <div class="row g-4 mb-3">
        <div class="col-sm-auto">
            <div>
                <a href="{{ route('admin.courses.create') }}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i>
                    Add New</a>
            </div>
        </div>
        <div class="col-sm">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                                ...
                                <div class="d-flex gap-1 align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{ route('admin.courses.detail') }}"><i
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="{{ route('admin.courses.detail') }}" class="text-body">Slack
                                        brand logo design</a></h5>
                                <p class="text-muted text-truncate-two-lines mb-3">Create a Brand logo design for a
                                    velzon admin.</p>
                            </div>
                        </div>
                        <div class="mt-auto">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="{{ route('admin.courses.detail') }}" class="text-body">Redesign -
                                        Landing page</a></h5>
                                <p class="text-muted text-truncate-two-lines mb-3">Resign a landing page design. as per
                                    abc minimal design.</p>
                            </div>
                        </div>
                        <div class="mt-auto">
                            <div class="d-flex mb-2">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="{{ route('admin.courses.detail') }}" class="text-body">Chat
                                        Application</a></h5>
                                <p class="text-muted text-truncate-two-lines mb-3">Create a Chat application for
                                    business messaging needs. Collaborate efficiently with secure direct messages and
                                    group chats.</p>
                            </div>
                        </div>
                        <div class="mt-auto">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="{{ route('admin.courses.detail') }}" class="text-body">Project
                                        App</a></h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-danger-subtle rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="{{ route('admin.courses.detail') }}"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-warning-subtle rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="{{ route('admin.courses.detail') }}" class="text-body">Dashboard
                                        UI</a></h5>
                            </div>
                            <div class="flex-shrink-0">
                                <div class="d-flex gap-1 align-items-center my-n2">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-info-subtle rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="{{ route('admin.courses.detail') }}" class="text-body">Vector
                                        Images</a></h5>
                            </div>
                            <div class="flex-shrink-0">
                                <div class="d-flex gap-1 align-items-center my-n2">
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="fs-14 mb-3"><a href="{{ route('admin.courses.detail') }}" class="text-body">Kanban
                                Board</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="{{ route('admin.courses.detail') }}" class="text-body">Ecommerce
                                app</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="{{ route('admin.courses.detail') }}" class="text-body">Redesign -
                                Landing page</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="{{ route('admin.courses.detail') }}" class="text-body">Multipurpose
