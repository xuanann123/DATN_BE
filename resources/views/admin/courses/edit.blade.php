                ...
                <div class="card-body">
                    <form action="{{ route('admin.courses.store') }}" method="post" class="form-steps"
                        ...
                        <div class="text-center pt-3 pb-4">
                            <h4 class="text-capitalize">Chỉnh Sửa Khoá Học {{ $course->name }}</h4>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            ...
                                            <div id="goals-container">
                                                ...
                                                {{-- Vòng lập dữ liệu ở đây về phần goals --}}
                                                @foreach ($course->goals as $goals)
                                                    <input type="text" class="form-control mb-2 rounded"
                                                        name="goals[]" id="inputField" value="{{ $goals->goal }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div id="requirements-container">
                                                @foreach ($course->requirements as $requirement)
                                                     <input type="text" class="form-control mb-2 rounded"
                                                    name="requirements[]" id="inputField" value="{{ $requirement->requirement }}"
                                                    placeholder="Ví dụ: Sẽ làm được một project với Laravel">
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            ...
                                            @foreach ($course->audiences as $audience)
                                                ...
                                                <input type="text" class="form-control mb-2 rounded"
                                                    name="audiences[]" id="inputField" value="{{ $audience->audience }}"
                                                    placeholder="Ví dụ: Sẽ làm được một project với Laravel">
                                            </div>
                                            @endforeach
                                ...
                                <div>
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted">Bạn có thể thêm các chương học, bài học và bài tập của khoá
                                            học này: <a style="cursor: pointer" href="{{ route('admin.courses.detail', $course->id) }}">Khoá học</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
