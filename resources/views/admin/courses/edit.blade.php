                                    ...
                                    <div>
                                            ...
                                            <div class="col-lg-8">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="slug"
                                                        name="slug" placeholder="Đường dẫn thân thiện"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                @if ($urlImage)
                                                    <img src="{{ $urlImage }}" class="img-fluid rounded"
                                                        id="show-image" alt="">
                                                @else
                                            ...
                                            <div class="col-lg-7">
                                                <p class="d-block">
                                                    Tải hình ảnh khóa học lên tại đây. Để được chấp nhận, hình ảnh phải đáp
                                                    ứng
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                @if ($urlVideo)
                                                    <video src="{{ $urlVideo }}" class="img-fluid rounded"
                                                        id="show-video" alt=""></video>
                                                @else
                                            ...
                                            <div class="col-lg-7">
                                                <p class="d-block">
                                                    Video quảng cáo của bạn là một cách nhanh chóng và hấp dẫn để học viên
                                                    xem
                                                    trước
                                                    những gì họ sẽ học trong khóa học của bạn. Học viên quan tâm đến khóa
                                                    học
                                                    của
                                    ...
                                    <div class="d-flex align-items-start gap-3 mt-4">
                                        <button type="submit"
                                            ...
                                            data-nexttab="pills-info-desc-tab"><i
                                                class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Cập nhật
                                            tổng
                                            quan khoá học</button>
                                    </div>
                                </form>
                            </div>
                            {{-- Cập nhật mục tiêu khoá học --}}
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-4">
                                            <div>
                                                ...
                                                <p class="text-muted">Các mô tả sau sẻ hiển thị công khai trên Trang tổng
                                                    quan
                                                    khoá học của bạn và sẽ tác động trực tiếp đến thành tích khoá học, đồng
                                                    thời
                                        ...
                                        <div class="row">
                                            <div class="mb-3">
                                                <div class="title mb-3">
                                                    ...
                                                    <p class="text-muted">Bạn phải nhập ít nhất 4 mục tiêu khoá học hoặc
                                                        kết
                                                        quả học tập mà học viên có thể mong đợi sau khi hoàn thành khoá học.
                                                    </p>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3">
                                                <div class="title mb-3">
                                                    <h5>Yêu cầu hoặc điều kiện tiên quyết để tham gia khóa học của bạn là
                                                        gì?
                                                    </h5>
                                                    <p class="text-muted">Liệt kê các kỹ năng, kinh nghiệm, công cụ hoặc
                                                        thiết
                                        ...
                                        <div class="row">
                                            <div class="mb-3">
                                                <div class="title mb-3">
                                                    ...
                                                    <p class="text-muted">Viết mô tả rõ ràng về học viên mục tiêu cho khóa
                                                        học,
                                                ...
                                                <div id="audiences-container">
                                                    @foreach ($course->audiences as $audience)
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-danger  remove-audience">
                                                                Xoá
                                                            </button>
                                                        </div>
                                                    @endforeach
                                                ...
                                                <button id="add-audience" class="inline-flex items-center btn btn-primary"
                                                    type="button"><svg stroke="currentColor" fill="currentColor"
                                                        stroke-width="0" viewBox="0 0 448 512" height="13px"
                                                        width="13px" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z">
                                                        </path>
                                    ...
                                    <div class="d-flex align-items-center gap-3 mt-4">
                                        <button type="submit"
                                            ...
                                            data-nexttab="pills-success-tab"><i
                                                class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Cập nhập
                                            mục
                                            tiêu khoá học</button>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <p class="fs-15">Bạn có thể thêm các chương học, bài học và bài tập của khoá
                                            học này: <a style="cursor: pointer"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" width="20px"
