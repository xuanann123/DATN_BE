            ...
            <div class="card">
                <div class="card-header">
                    <div class="row g-3">
                        ...
                        <div class="col-sm">
                            <form action="{{ route('admin.users.list-admin') }}">
                                        ...
                                        <td>
                                            @if ($item->roles->count() > 0)
                                                @foreach ($item->roles as $role)
                                                    <a href="{{ route("admin.roles.edit", $role->id) }}" class="badge bg-danger mr-2">{{ $role->name }}</a>
                                                @endforeach
                                            @else
                                                <span class="badge bg-warning mr-2">Chưa có quyền trên hệ thống</span></a>
                                            @endif
                                        </td>
