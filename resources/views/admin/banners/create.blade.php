                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('.adminbanners.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" value="{{ old('title') }}" id="title" name="title" placeholder="Title" class="form-control"><small class="help-block form-text text-danger">
                                  @if ($errors->has('title'))
                                    {{ $errors->first('title') }}
                                  @endif  
                                </small></div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" value="{{ old('redirect_url') }}" id="redirect-url" name="redirect_url" placeholder="Redirect url" class="form-control"><small class="help-block form-text text-danger">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" value="{{ old('position') }}" id="position" name="position" placeholder="Position" class="form-control"><small class="help-block form-text text-danger">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="datetime-local" value="{{ old('start_time') }}" id="start-time" name="start_time" placeholder="Start time" class="form-control"><small class="help-block form-text text-danger">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="datetime-local" id="end-time" value="{{ old('end_time') }}" name="end_time" placeholder="End time" class="form-control"><small class="help-block form-text text-danger">
